...
libblecontroller/hci_msg.o:     file format elf32-littleriscv
...
00000036 <.LVL15>:
  36:	00000097          	auipc	ra,0x0
			36: R_RISCV_CALL	hci_pack_bytes
...
00000046 <.L12>:
  ...
  4e:	00d7f463          	bgeu	a5,a3,56 <.L11>
			4e: R_RISCV_BRANCH	.L11
  52:	02ec7463          	bgeu	s8,a4,7a <.L13>
			52: R_RISCV_BRANCH	.L13
...
000000aa <.LVL26>:
  ...
  ac:	00000097          	auipc	ra,0x0
			ac: R_RISCV_CALL	hci_pack_bytes
			ac: R_RISCV_RELAX	*ABS*
  b0:	000080e7          	jalr	ra # ac <.LVL26+0x2>

000000b4 <.LVL27>:
  b4:	e501                	bnez	a0,bc <.L16>
			b4: R_RISCV_RVC_BRANCH	.L16
  b6:	0ff97793          	andi	a5,s2,255

000000ba <.LVL28>:
  ba:	b771                	j	46 <.L12>
			ba: R_RISCV_RVC_JUMP	.L12

000000bc <.L16>:
  bc:	8aaa                	mv	s5,a0
  be:	bf61                	j	56 <.L11>
			be: R_RISCV_RVC_JUMP	.L11
...
00000030 <.LVL39>:
  ...
  34:	00000097          	auipc	ra,0x0
			34: R_RISCV_CALL	hci_pack_bytes
...
0000004e <.LVL42>:
  ...
  50:	00000097          	auipc	ra,0x0
			50: R_RISCV_CALL	hci_pack_bytes
...
00000122 <.LVL63>:
 ...
 124:	00000097          	auipc	ra,0x0
			124: R_RISCV_CALL	hci_pack_bytes
...
0000012c <.LVL64>:
 ...
 130:	e119                	bnez	a0,136 <.L31>
			130: R_RISCV_RVC_BRANCH	.L31

00000132 <.LBE5>:
 132:	0b05                	addi	s6,s6,1
 134:	b73d                	j	62 <.L22>
			134: R_RISCV_RVC_JUMP	.L22

00000136 <.L31>:
 136:	842a                	mv	s0,a0
 138:	bf0d                	j	6a <.L21>
			138: R_RISCV_RVC_JUMP	.L21

0000013a <.L19>:
 13a:	00061023          	sh	zero,0(a2)
 13e:	4401                	li	s0,0
 140:	bf15                	j	74 <.L24>
			140: R_RISCV_RVC_JUMP	.L24
...
00000000 <hci_le_dir_adv_report_evt_pkupk>:
  ...
  14:	12058163          	beqz	a1,136 <.L34>
			14: R_RISCV_BRANCH	.L34
  18:	89aa                	mv	s3,a0
  1a:	c925                	beqz	a0,8a <.L40>
			1a: R_RISCV_RVC_BRANCH	.L40
...
00000120 <.LVL97>:
 ...
 122:	00000097          	auipc	ra,0x0
			122: R_RISCV_CALL	hci_pack_bytes
...
0000012a <.LVL98>:
 ...
 12c:	e119                	bnez	a0,132 <.L46>
			12c: R_RISCV_RVC_BRANCH	.L46
 12e:	0b05                	addi	s6,s6,1
 130:	bf0d                	j	62 <.L37>
			130: R_RISCV_RVC_JUMP	.L37

00000132 <.L46>:
 132:	842a                	mv	s0,a0
 134:	bf1d                	j	6a <.L36>
			134: R_RISCV_RVC_JUMP	.L36

00000136 <.L34>:
 136:	00061023          	sh	zero,0(a2)
 13a:	4401                	li	s0,0
 13c:	bf25                	j	74 <.L39>
			13c: R_RISCV_RVC_JUMP	.L39
...
00000014 <.LVL104>:
  ...
  16:	02e78e63          	beq	a5,a4,52 <.L55>
			16: R_RISCV_BRANCH	.L55

0000001a <.LVL105>:
  1a:	4715                	li	a4,5
  1c:	02e78d63          	beq	a5,a4,56 <.L56>
			1c: R_RISCV_BRANCH	.L56

00000020 <.LVL106>:
  20:	4721                	li	a4,8
  22:	02e78c63          	beq	a5,a4,5a <.L57>
			22: R_RISCV_BRANCH	.L57
...
0000002c <.LVL108>:
  2c:	04e79663          	bne	a5,a4,78 <.L48>
			2c: R_RISCV_BRANCH	.L48
  30:	4795                	li	a5,5

00000032 <.L49>:
  32:	00000737          	lui	a4,0x0
			32: R_RISCV_HI20	.LANCHOR0
