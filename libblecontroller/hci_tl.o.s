...
libblecontroller/hci_tl.o:     file format elf32-littleriscv
...
00000026 <.LVL4>:
  26:	00000097          	auipc	ra,0x0
			26: R_RISCV_CALL	hci_util_unpack
			26: R_RISCV_RELAX	*ABS*
  2a:	000080e7          	jalr	ra # 26 <.LVL4>

0000002e <.L5>:
  2e:	e131                	bnez	a0,72 <.L1>
			2e: R_RISCV_RVC_BRANCH	.L1
...
0000005e <.L10>:
  5e:	00000097          	auipc	ra,0x0
			5e: R_RISCV_CALL	ble_ke_msg_alloc
...
00000066 <.LVL17>:
  ...
  6a:	00000097          	auipc	ra,0x0
			6a: R_RISCV_CALL	hci_send_2_host
...
00000030 <.L36>:
  30:	00000097          	auipc	ra,0x0
			30: R_RISCV_CALL	ble_co_list_push_back
...
00000048 <.LBE59>:
  48:	e901                	bnez	a0,58 <.L16>
			48: R_RISCV_RVC_BRANCH	.L16
  4a:	00000097          	auipc	ra,0x0
			4a: R_RISCV_CALL	hci_fc_check_host_available_nb_acl_packets
			4a: R_RISCV_RELAX	*ABS*
  4e:	000080e7          	jalr	ra # 4a <.LBE59+0x2>

00000052 <.LVL27>:
  52:	cd39                	beqz	a0,b0 <.L11>
			52: R_RISCV_RVC_BRANCH	.L11
...
000000a0 <.L26>:
  ...
  a4:	00000097          	auipc	ra,0x0
			a4: R_RISCV_CALL	hci_build_cc_evt
...
00000100 <.LBE69>:
 100:	b775                	j	ac <.L18>
			100: R_RISCV_RVC_JUMP	.L18

00000102 <.L22>:
 102:	00000097          	auipc	ra,0x0
			102: R_RISCV_CALL	hci_build_evt
			102: R_RISCV_RELAX	*ABS*
 106:	000080e7          	jalr	ra # 102 <.L22>

0000010a <.LVL43>:
 10a:	b74d                	j	ac <.L18>
			10a: R_RISCV_RVC_JUMP	.L18

0000010c <.L21>:
 10c:	00000097          	auipc	ra,0x0
			10c: R_RISCV_CALL	hci_build_le_evt
			10c: R_RISCV_RELAX	*ABS*
 110:	000080e7          	jalr	ra # 10c <.L21>

00000114 <.LVL45>:
 114:	bf61                	j	ac <.L18>
			114: R_RISCV_RVC_JUMP	.L18

00000116 <.L19>:
 116:	00000097          	auipc	ra,0x0
			116: R_RISCV_CALL	hci_build_acl_rx_data
			116: R_RISCV_RELAX	*ABS*
 11a:	000080e7          	jalr	ra # 116 <.L19>

0000011e <.LBB81>:
 11e:	b779                	j	ac <.L18>
			11e: R_RISCV_RVC_JUMP	.L18
...
00000000 <hci_cmd_received>:
  ...
  14:	00000097          	auipc	ra,0x0
			14: R_RISCV_CALL	hci_look_for_cmd_desc
...
00000066 <.LVL63>:
  66:	02090863          	beqz	s2,96 <.L55>
			66: R_RISCV_BRANCH	.L55
  6a:	40d8                	lw	a4,4(s1)
  6c:	c70d                	beqz	a4,96 <.L55>
			6c: R_RISCV_RVC_BRANCH	.L55
  ...
  80:	efb5                	bnez	a5,fc <.L56>
			80: R_RISCV_RVC_BRANCH	.L56
  82:	4581                	li	a1,0
  84:	4501                	li	a0,0
  86:	00000097          	auipc	ra,0x0
			86: R_RISCV_CALL	hci_util_unpack
...
00000096 <.L55>:
  ...
  a4:	00000097          	auipc	ra,0x0
			a4: R_RISCV_CALL	ble_ke_msg_alloc
			a4: R_RISCV_RELAX	*ABS*
...
000000ae <.LVL67>:
  ae:	ed29                	bnez	a0,108 <.L59>
			ae: R_RISCV_RVC_BRANCH	.L59

000000b0 <.L47>:
  b0:	461d                	li	a2,7
  b2:	a029                	j	bc <.L80>
			b2: R_RISCV_RVC_JUMP	.L80

000000b4 <.L51>:
  b4:	4785                	li	a5,1
  b6:	0127ea63          	bltu	a5,s2,ca <.L53>
			b6: R_RISCV_BRANCH	.L53
...
000000c0 <.L79>:
  c0:	00000097          	auipc	ra,0x0
			c0: R_RISCV_CALL	hci_cmd_reject
			c0: R_RISCV_RELAX	*ABS*
  c4:	000080e7          	jalr	ra # c0 <.L79>

000000c8 <.LVL72>:
  c8:	a88d                	j	13a <.L44>
			c8: R_RISCV_RVC_JUMP	.L44
...
000000dc <.LVL75>:
  ...
  e6:	00000097          	auipc	ra,0x0
			e6: R_RISCV_CALL	ble_ke_state_get
...
000000ee <.LVL76>:
  ...
  f2:	f6f518e3          	bne	a0,a5,62 <.L49>
			f2: R_RISCV_BRANCH	.L49
  f6:	b7d1                	j	ba <.L54>
			f6: R_RISCV_RVC_JUMP	.L54

000000f8 <.L62>:
  f8:	440d                	li	s0,3
  fa:	b7a5                	j	62 <.L49>
			fa: R_RISCV_RVC_JUMP	.L49
...
00000106 <.LVL80>:
 106:	b761                	j	8e <.L57>
			106: R_RISCV_RVC_JUMP	.L57

00000108 <.L59>:
 108:	00e15783          	lhu	a5,14(sp)
 10c:	c395                	beqz	a5,130 <.L60>
			10c: R_RISCV_RVC_BRANCH	.L60
 10e:	40d8                	lw	a4,4(s1)
 110:	c305                	beqz	a4,130 <.L60>
			110: R_RISCV_RVC_BRANCH	.L60
 ...
 126:	e395                	bnez	a5,14a <.L61>
			126: R_RISCV_RVC_BRANCH	.L61

00000128 <.LVL82>:
 128:	00000097          	auipc	ra,0x0
			128: R_RISCV_CALL	hci_util_unpack
...
00000130 <.L60>:
 ...
 132:	00000097          	auipc	ra,0x0
			132: R_RISCV_CALL	ble_ke_msg_send
...
0000014c <.LVL88>:
 14c:	b7d5                	j	130 <.L60>
			14c: R_RISCV_RVC_JUMP	.L60

0000014e <.L45>:
 14e:	f12d                	bnez	a0,b0 <.L47>
			14e: R_RISCV_RVC_BRANCH	.L47
...
00000042 <.LBE103>:
  42:	000007b7          	lui	a5,0x0
			42: R_RISCV_HI20	.LANCHOR0+0x14
			42: R_RISCV_RELAX	*ABS*+0x14
  46:	00a7aa23          	sw	a0,20(a5) # 14 <hci_acl_tx_data_alloc+0x14>
			46: R_RISCV_LO12_S	.LANCHOR0+0x14
			46: R_RISCV_RELAX	*ABS*+0x14
  4a:	cd01                	beqz	a0,62 <.L83>
			4a: R_RISCV_RVC_BRANCH	.L83
...
00000044 <.LVL108>:
  ...
  48:	00000097          	auipc	ra,0x0
			48: R_RISCV_CALL	ble_ke_msg_alloc
