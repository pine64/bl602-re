...
libblecontroller/llm_task.o:     file format elf32-littleriscv
...
00000000 <llm_le_set_host_ch_class_cmd_sto_handler>:
   0:	000007b7          	lui	a5,0x0
			0: R_RISCV_HI20	llm_le_env+0x37
			0: R_RISCV_RELAX	*ABS*+0x37
   4:	4705                	li	a4,1
   6:	02e78ba3          	sb	a4,55(a5) # 37 <.LVL25+0x1>
			6: R_RISCV_LO12_S	llm_le_env+0x37
			6: R_RISCV_RELAX	*ABS*+0x37
   a:	4501                	li	a0,0
...
00000026 <.LVL6>:
  26:	00000097          	auipc	ra,0x0
			26: R_RISCV_CALL	llm_util_check_evt_mask
			26: R_RISCV_RELAX	*ABS*
  2a:	000080e7          	jalr	ra # 26 <.LVL6>

0000002e <.LVL7>:
  2e:	c129                	beqz	a0,70 <.L6>
			2e: R_RISCV_RVC_BRANCH	.L6
...
00000030 <.LBB5>:
  ...
  40:	00000097          	auipc	ra,0x0
			40: R_RISCV_CALL	ble_ke_msg_alloc
...
0000008c <.LVL15>:
  8c:	00000097          	auipc	ra,0x0
			8c: R_RISCV_CALL	llm_util_check_evt_mask
...
00000096 <.LBB7>:
  ...
  a6:	00000097          	auipc	ra,0x0
			a6: R_RISCV_CALL	ble_ke_msg_alloc
...
000000ae <.LVL17>:
  ...
  b8:	000004b7          	lui	s1,0x0
			b8: R_RISCV_HI20	ble_memcpy_ptr
...
00000020 <.LVL23>:
  ...
  24:	e791                	bnez	a5,30 <.L14>
			24: R_RISCV_RVC_BRANCH	.L14
  26:	8526                	mv	a0,s1
  28:	00000097          	auipc	ra,0x0
			28: R_RISCV_CALL	llm_encryption_start
...
00000026 <.LVL30>:
  ...
  2a:	06f50b63          	beq	a0,a5,a0 <.L18>
			2a: R_RISCV_BRANCH	.L18
  2e:	4501                	li	a0,0
  30:	00000097          	auipc	ra,0x0
			30: R_RISCV_CALL	ble_ke_state_get
...
00000038 <.LVL31>:
  ...
  6c:	00000097          	auipc	ra,0x0
			6c: R_RISCV_CALL	llm_common_cmd_complete_send
...
0000007e <.L28>:
  ...
  82:	a879                	j	120 <.L26>
			82: R_RISCV_RVC_JUMP	.L26

00000084 <.L17>:
  84:	4501                	li	a0,0
  86:	00000097          	auipc	ra,0x0
			86: R_RISCV_CALL	ble_ke_state_get
...
000000d2 <.L22>:
  ...
  e2:	02f76b63          	bltu	a4,a5,118 <.L24>
			e2: R_RISCV_BRANCH	.L24

000000e6 <.L46>:
  e6:	04e45503          	lhu	a0,78(s0)
  ea:	4581                	li	a1,0
  ec:	00000097          	auipc	ra,0x0
			ec: R_RISCV_CALL	llm_common_cmd_complete_send
...
000000f4 <.LVL37>:
  ...
  fa:	00f71a63          	bne	a4,a5,10e <.L25>
			fa: R_RISCV_BRANCH	.L25
  fe:	65c1                	lui	a1,0x10
 100:	4601                	li	a2,0
 102:	15fd                	addi	a1,a1,-1
 104:	4509                	li	a0,2
 106:	00000097          	auipc	ra,0x0
			106: R_RISCV_CALL	llc_le_con_cmp_evt_send
...
00000146 <.LVL40>:
 146:	00000097          	auipc	ra,0x0
			146: R_RISCV_CALL	ble_ke_state_set
...
0000014e <.LBE13>:
 ...
 154:	b789                	j	96 <.L21>
			154: R_RISCV_RVC_JUMP	.L21

00000156 <.L27>:
 156:	4501                	li	a0,0
 158:	00000097          	auipc	ra,0x0
			158: R_RISCV_CALL	ble_ke_state_get
...
00000160 <.LVL42>:
 ...
 188:	f4f6ffe3          	bgeu	a3,a5,e6 <.L46>
			188: R_RISCV_BRANCH	.L46
 18c:	47c5                	li	a5,17
 18e:	f8f715e3          	bne	a4,a5,118 <.L24>
			18e: R_RISCV_BRANCH	.L24
 192:	bf91                	j	e6 <.L46>
			192: R_RISCV_RVC_JUMP	.L46

00000194 <.L29>:
 194:	a001                	j	194 <.L29>
			194: R_RISCV_RVC_JUMP	.L41

00000196 <.L33>:
 196:	487c                	lw	a5,84(s0)
 198:	e781                	bnez	a5,1a0 <.L36>
			198: R_RISCV_RVC_BRANCH	.L36
 19a:	0f057593          	andi	a1,a0,240
 19e:	b75d                	j	144 <.L43>
			19e: R_RISCV_RVC_JUMP	.L43

000001a0 <.L36>:
 1a0:	a001                	j	1a0 <.L36>
			1a0: R_RISCV_RVC_JUMP	.L36
