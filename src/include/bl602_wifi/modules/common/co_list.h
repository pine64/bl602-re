...
static inline struct co_list_hdr* co_list_pick(struct co_list const* const list) {
    return list->first;
}

static inline struct co_list_hdr* co_list_next(struct co_list_hdr const* const list_hdr) {
