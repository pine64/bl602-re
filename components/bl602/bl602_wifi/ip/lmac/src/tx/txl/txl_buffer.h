...
*/
#ifndef __TXL_BUFFER_H__
#define __TXL_BUFFER_H__
...
struct txl_buffer_env_tag txl_buffer_env;struct txl_buffer_control txl_buffer_control_desc[10];struct txl_buffer_control txl_buffer_control_desc_bcmc[2];

#endif // __TXL_BUFFER_H__
