...
libatcmd/at_config.o:     file format elf32-littleriscv
...
00000000 <at_getcfg>:
  ...
  28:	00078993          	mv	s3,a5
			28: R_RISCV_LO12_I	.LANCHOR1
			28: R_RISCV_RELAX	*ABS*
  2c:	4481                	li	s1,0
  2e:	00078413          	mv	s0,a5
			2e: R_RISCV_LO12_I	.LANCHOR1
...
000000b4 <.L14>:
  ...
  b8:	f7549ee3          	bne	s1,s5,34 <.L15>
			b8: R_RISCV_BRANCH	.L15
  bc:	451d                	li	a0,7
  be:	bfd1                	j	92 <.L13>
			be: R_RISCV_RVC_JUMP	.L13
...
0000004e <.L24>:
  ...
  52:	fd4418e3          	bne	s0,s4,22 <.L25>
			52: R_RISCV_BRANCH	.L25
  56:	451d                	li	a0,7
  58:	b7dd                	j	3e <.L23>
			58: R_RISCV_RVC_JUMP	.L23
...
00000000 <at_setcfg>:
   0:	c959                	beqz	a0,96 <.L49>
			0: R_RISCV_RVC_BRANCH	.L49
   2:	c9d1                	beqz	a1,96 <.L49>
			2: R_RISCV_RVC_BRANCH	.L49
...
00000036 <.LVL40>:
  ...
  48:	02d61263          	bne	a2,a3,6c <.L35>
			48: R_RISCV_BRANCH	.L35
  4c:	4b9c                	lw	a5,16(a5)
  4e:	eb8d                	bnez	a5,80 <.L36>
			4e: R_RISCV_RVC_BRANCH	.L36
...
00000084 <.LVL46>:
  ...
  86:	d569                	beqz	a0,50 <.L37>
			86: R_RISCV_RVC_BRANCH	.L37
  88:	b7d5                	j	6c <.L35>
			88: R_RISCV_RVC_JUMP	.L35

0000008a <.L34>:
  8a:	0405                	addi	s0,s0,1
  8c:	0a51                	addi	s4,s4,20
  8e:	f9541de3          	bne	s0,s5,28 <.L38>
			8e: R_RISCV_BRANCH	.L38
  92:	471d                	li	a4,7
  94:	bfe1                	j	6c <.L35>
			94: R_RISCV_RVC_JUMP	.L35
...
0000000e <.LBB2>:
   e:	00000937          	lui	s2,0x0
			e: R_RISCV_HI20	at_cfg+0x118
			e: R_RISCV_RELAX	*ABS*+0x118
  12:	00000097          	auipc	ra,0x0
			12: R_RISCV_CALL	strlen
...
0000001c <.LVL52>:
  ...
  22:	11890513          	addi	a0,s2,280 # 118 <.LC23>
			22: R_RISCV_LO12_I	at_cfg+0x118
			22: R_RISCV_RELAX	*ABS*+0x118
...
0000002e <.LVL53>:
  ...
  32:	11890513          	addi	a0,s2,280
			32: R_RISCV_LO12_I	at_cfg+0x118
			32: R_RISCV_RELAX	*ABS*+0x118
...
00000042 <.LBB3>:
  42:	000007b7          	lui	a5,0x0
			42: R_RISCV_HI20	at_cfg+0x13c
			42: R_RISCV_RELAX	*ABS*+0x13c
  46:	1297ae23          	sw	s1,316(a5) # 13c <.LASF432+0x1>
			46: R_RISCV_LO12_S	at_cfg+0x13c
			46: R_RISCV_RELAX	*ABS*+0x13c
...
00000000 <at_factory>:
   ...
   6:	00078793          	mv	a5,a5
			6: R_RISCV_LO12_I	at_cfg
			6: R_RISCV_RELAX	*ABS*
   a:	c23e                	sw	a5,4(sp)
   c:	000007b7          	lui	a5,0x0
			c: R_RISCV_HI20	at_callback
			c: R_RISCV_RELAX	*ABS*
