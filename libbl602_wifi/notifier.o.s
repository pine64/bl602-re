...
libbl602_wifi/notifier.o:     file format elf32-littleriscv
...
00000000 <notifier_chain_regsiter>:
   ...
   8:	00000097          	auipc	ra,0x0
			8: R_RISCV_CALL	vTaskEnterCritical
			8: R_RISCV_RELAX	*ABS*
...
00000014 <.L2>:
  ...
  16:	eb99                	bnez	a5,2c <.L4>
			16: R_RISCV_RVC_BRANCH	.L4

00000018 <.L3>:
  18:	c1dc                	sw	a5,4(a1)
  1a:	c10c                	sw	a1,0(a0)
  1c:	00000097          	auipc	ra,0x0
			1c: R_RISCV_CALL	vTaskExitCritical
...
00000014 <.L11>:
  ...
  18:	00000097          	auipc	ra,0x0
			18: R_RISCV_CALL	vTaskExitCritical
			18: R_RISCV_RELAX	*ABS*
  1c:	000080e7          	jalr	ra # 18 <.L11+0x4>

00000020 <.LVL14>:
  20:	a029                	j	2a <.L13>
			20: R_RISCV_RVC_JUMP	.L13
...
00000010 <.LVL25>:
  10:	00000097          	auipc	ra,0x0
			10: R_RISCV_CALL	vTaskEnterCritical
			10: R_RISCV_RELAX	*ABS*
  14:	000080e7          	jalr	ra # 10 <.LVL25>

00000018 <.L22>:
  18:	ec01                	bnez	s0,30 <.L23>
			18: R_RISCV_RVC_BRANCH	.L23
  1a:	00000097          	auipc	ra,0x0
			1a: R_RISCV_CALL	vTaskExitCritical
